...
export function Footer() {
  ...
  return (
    <footer className="relative py-12 border-t border-[var(--color-border)]/50 overflow-hidden">
      ...
      <div className="container-narrow">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          >
            <span className="font-bold text-2xl bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-accent-2)] bg-clip-text text-transparent">
              VD
            </span>
          ...
          >
            ...
            <a
              href="https://github.com/vivekdogra2012"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[var(--color-muted)] hover:text-[var(--color-accent)] transition-colors duration-300"
              aria-label="GitHub"
          ...
          <motion.p
            ...
            className="text-xs text-[var(--color-muted)]/60 font-mono"
          >
